    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="wmsadmin.php">e-SWACHH BHARAT ADMIN</a>
        </div>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active"><a href="wmsadmin.php">User Post's <span class="sr-only">(current)</span></a></li>
...
<!--hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh-->
		...
		echo "</table>";
				...
				{
				echo "<button type='submit' class='btn btn-primary' name='Ignore'>Ignore Post</button>";
				echo "   <button type='submit' class='btn btn-primary' name='fwd'>Forward to maintainance</button>";
				}
				else
				{
