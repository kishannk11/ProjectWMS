...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="">e-SWACCH BHARAT MAINTANANCE</a>
        </div>
    ...
    <div class="container">
        ...
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li ><a href="wmsmain.php">Daily task <span class="sr-only">(current)</span></a></li>
            <li class="active"><a href="completedtask.php">Completed task</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h1 class="page-header">Completed Task Report</h1>
			...
			<input type="text" name="T1" placeholder="valid pincode..." class="form-control"  id="i1" onblur="convert_caps(this.id,this.value);">
				...
				<button type="submit" class="btn btn-primary" name="find">Find pincode</button>	
			</form>
	 ...
	 if(isset($_POST['find'])) 
	{
		...
		header('location:mainfindpincode.php');
